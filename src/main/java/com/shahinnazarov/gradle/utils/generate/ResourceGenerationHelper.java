...
public interface ResourceGenerationHelper {
    ...
    default boolean checkAnyKeyStartWith(Collection<String> keys, String pattern) {
        return keys.stream().anyMatch(key -> key.startsWith(pattern));
    }
}
